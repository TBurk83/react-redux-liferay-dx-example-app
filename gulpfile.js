...
gulp.task('build', function () {
  sequence('clean',['install-react-runtime','resources','app_dev']) (function (err) {
...
gulp.task('prod', function () {
  sequence('clean',['install-react-runtime','resources','app_prod']) (function (err) {
    if (err) console.log(err);
  })
});
...
gulp.task('watch', (cb) => {
  ...
  gulp.watch([config.build_dir + "/index.js"]).on('change', function (e) {
